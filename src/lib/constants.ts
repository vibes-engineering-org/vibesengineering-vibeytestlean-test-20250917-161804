export const PROJECT_TITLE = "VibeyTest lean-test-20250917-161804";
export const PROJECT_DESCRIPTION = "by @vibes.engineering";
export const PROJECT_CREATOR = "vibes.engineering";
